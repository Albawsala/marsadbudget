...
tinymce.PluginManager.add('linkmanager', function(editor) {
	...
	function showDialog(linkList)
	{
		...
		$('#'+win.find('#href')[0]._id +'-inp').autocomplete({
			source: $(editor.getElement()).hasClass('ar') ? deputes_autocomplete_ar : deputes_autocomplete,
			messages: {
		        noResults: '',
		        results: function() {}
		    }
